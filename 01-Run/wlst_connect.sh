...
# =============================================================================
# Launch WLST
# Pipe the connect script to WLST stdin, then forward the terminal input.
# WLST without a file argument reads from stdin – this keeps it interactive
# after the auto-connect without relying on interact() (not available in
# script-file mode in all WLST versions).
# =============================================================================
...
{ cat "$TMP_PY"; cat; } | "$WLST_SH"
WLST_RC="${PIPESTATUS[1]}"
